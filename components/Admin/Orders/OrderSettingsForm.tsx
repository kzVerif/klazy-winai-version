...
import { updatetOrderSetting } from "@/lib/database/orders";

export default function OrderSettingsForm({ data }: { data: any }) {
  ...
  return (
    ...
    >
      <h1 className="text-xl font-semibold text">สินค้าแบบพรีออเดอร์</h1>
      ...
      <div className="grid gap-3">
        <Label htmlFor="image">รูปภาพหมวดหมู่สินค้าพรีออเดอร์</Label>
        <Input
          id="image"
          name="image"
